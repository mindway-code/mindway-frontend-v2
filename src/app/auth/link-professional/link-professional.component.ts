...
@Component({
  selector: "app-link-professional",
  standalone: false,
  templateUrl: "./link-professional.component.html",
  styleUrl: "./link-professional.component.css",
})
export class LinkProfessionalComponent {
